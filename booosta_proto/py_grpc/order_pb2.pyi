...
class Order(_message.Message):
    __slots__ = ["amount_payment", "balance", "created_by_id", "customer_id", "discount", "grand_total", "id", "payment_option", "payment_type", "shipping_fee", "status", "total_price", "transaction_id"]
